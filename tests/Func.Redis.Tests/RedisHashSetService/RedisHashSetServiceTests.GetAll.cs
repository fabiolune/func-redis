...
public partial class RedisHashSetServiceTests
{
    ...
    [TestCase(null)]
    [TestCase("something")]
    public void GetAll_WhenDatabaseIsNull_ShouldReturnError(string prefix)
    {
    ...
    [TestCase("prefix:", "prefix:key")]
    [TestCase("prefix::", "prefix:key")]
    public void GetAll_WhenDatabaseThrowsException_ShouldReturnError(string prefix, string key)
    {
    ...
    [TestCase("prefix:", "prefix:key")]
    [TestCase("prefix::", "prefix:key")]
    public void GetAll_WhenDatabaseReturnsItemWithNoValue_ShouldReturnRightWithNone(string prefix, string key)
    {
        _sut = new Redis.RedisHashSetService(_mockProvider, _mockSerDes, new RedisKeyConfiguration
        {
            KeyPrefix = prefix
    ...
    [TestCase("prefix:", "prefix:key")]
    [TestCase("prefix::", "prefix:key")]
    public void GetAll_WhenSerDesThrows_ShouldReturnLeft(string prefix, string key)
    {
        _sut = new Redis.RedisHashSetService(_mockProvider, _mockSerDes, new RedisKeyConfiguration
        {
            KeyPrefix = prefix
    ...
    [TestCase("prefix:", "prefix:key")]
    [TestCase("prefix::", "prefix:key")]
    public void GetAll_WhenDatabaseReturnsValidJson_ShouldReturnRightWithSome(string prefix, string key)
    {
        _sut = new Redis.RedisHashSetService(_mockProvider, _mockSerDes, new RedisKeyConfiguration
        {
            KeyPrefix = prefix
    ...
    [TestCase("prefix:", "prefix:key")]
    [TestCase("prefix::", "prefix:key")]
    public void GetAll_WhenDatabaseReturnsMoreValidJsonSerialization_ShouldReturnRightWithSome(string prefix, string key)
    {
        _sut = new Redis.RedisHashSetService(_mockProvider, _mockSerDes, new RedisKeyConfiguration
        {
            KeyPrefix = prefix
